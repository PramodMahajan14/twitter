...
interface UserIconProps {
  size?: number | string; // Optional size: 24, "2rem", etc.
  color?: string; // Optional color: "currentColor", "#000", etc.
  className?: string; // Optional additional Tailwind or custom class
}
